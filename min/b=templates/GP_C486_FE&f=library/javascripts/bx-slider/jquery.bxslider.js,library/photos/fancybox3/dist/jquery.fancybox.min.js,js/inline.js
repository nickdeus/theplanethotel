...
;$(window).load(function(){$(window).scroll(function(){if($(this).scrollTop()>100){$('#toTop').stop().fadeIn();}else{$('#toTop').stop().fadeOut();}});$('<a href="#" id="toTop" class="toTopButton" style="display:none"><i class="fas fa-chevron-up"></i></a>').appendTo("body");$("#toTop").click(function(e){e.preventDefault();$('body,html').animate({scrollTop:0},600);});});$(document).ready(function(){initFancybox()})
